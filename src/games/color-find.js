...
export function render(container, difficulty = 'easy') {
  ...
  ['easy', 'normal', 'hard'].forEach(d => {
    ...
    btn.addEventListener('click', () => {
      track('difficulty_change', { game_id: 'color-find', difficulty: d });
      container.innerHTML = '';
      render(container, d);
    });
...
function onFinish() {
  ...
  track('game_complete', { game_id: 'color-find', difficulty: currentDifficulty, score: finalScore, total_plays: getTotalPlays() });
